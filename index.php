...
$transport = (new Swift_SmtpTransport('ssmtp.mailtrap.io', 2525))
  ->setUsername('f1b95aec6834fe')
  ->setPassword('6b012857669885');
...
$messages->setSubject('Demo message using the SwiftMailer');
$messages->setFrom(['kaito.083097@gmail.com' => 'kaito']);
